...
export const MODULES = {
  ...
  allocation: { label: 'Teacher Allocation', icon: 'grid' },
  myclasses: { label: 'My Classes & Subjects', icon: 'grid' },
  substitution: { label: 'Substitutions', icon: 'refresh' },
  staffatt: { label: 'Staff Attendance', icon: 'user-check' },
  classroles: { label: 'Class Roles & CR', icon: 'badge' },
  promotion: { label: 'Promotion & Year-end', icon: 'trend' },
...
export const ROLES = [
  {
    ...
    nav: [
      ...
      ['Academic', ['teachers', 'classes', 'allocation', 'timetable', 'substitution', 'attendance', 'lessons', 'homework', 'tests', 'results', 'classroles', 'library']],
      ['Staff', ['staffatt', 'promotion']],
  ...
  },
  {
    ...
    nav: [
      ['My Day', ['dashboard', 'timetable', 'myclasses', 'substitution', 'calendar', 'notifications']],
      ['Classroom', ['attendance', 'lessons', 'homework', 'tests', 'results', 'students', 'classroles']],
  ...
  },
  {
    ...
    nav: [
      ['My School', ['dashboard', 'timetable', 'homework', 'tests', 'attendance', 'results', 'classroles']],
...
export const ROLE_PERMISSIONS = {
  school_admin: ALL.filter((p) => !['allocation.publish', 'classroles.approve'].includes(p)),
  principal: ALL.filter((p) => !['payroll.manage', 'fees.refund'].includes(p)),
  // school admin prepares allocation drafts; only the principal publishes
